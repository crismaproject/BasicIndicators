...
class Process(WPSProcess):
    ...
    def execute(self):
        ...
        self.status.set("Calculated deathsIndicator for WorldState with id {}: {}".format (worldStateId, numberOfDeaths), 90)
